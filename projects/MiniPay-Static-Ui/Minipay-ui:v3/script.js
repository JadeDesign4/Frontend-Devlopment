...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ---------------------------------------------------------------------- */
    /*  Currency switching + hide balance (index page)                        */
    /* ---------------------------------------------------------------------- */
    ...
    function renderBalance(currency) {
        ...
        const amount = currencyMap[currency].amount;
        balanceValue.dataset.currencyValue = amount;
    ...
    $$('.feature-card, .share-card, .crypto-card, .feature-item').forEach(card => {
        card.addEventListener('click', (e) => {
            // Don't intercept clicks on buttons inside feature cards
